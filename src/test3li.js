...
function convertIntoHtml(obj) {
  ...
  for (let key in obj) {
    ...
    //     if there's another level to the object, recursively call function
    //     create a new ul which will add after text
    ...
    //     add completed li to the ul
    ul.appendChild(li);
  }
  ul.insertAdjacentHTML("afterbegin", "dem");
  return ul;
}
